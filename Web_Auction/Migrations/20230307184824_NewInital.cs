    ...
    public partial class NewInital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LotProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    PriceLotOpen = table.Column<double>(type: "double precision", nullable: false),
                    PriceLotOffer = table.Column<double>(type: "double precision", nullable: false),
                    AuctionInformationAuctionId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LotProducts", x => x.LotProductId);
                    table.ForeignKey(
                        name: "FK_LotProducts_AuctionInformationS_AuctionInformationAuctionId",
                        column: x => x.AuctionInformationAuctionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressMember = table.Column<string>(type: "text", nullable: true),
                    PhoneNumberMember = table.Column<string>(type: "text", nullable: true),
                    Deposit = table.Column<double>(type: "double precision", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardMembers", x => x.CardId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_LotProducts_LotProductId",
